...
function App() {
  ...
  etter parameteren slik at hvis jeg f.eks søker på big, så vil søkeresultatet inkludere ord som starter med big*/
    
  /*Jeg skjønte ikke helt hvordan jeg skulle få til å få mer informasjon fra det samme API-kallet, så jeg bestemte meg for å
  lage enda et API-kall. Denne henter fram ekstra informasjon av posterne som ble kalt i det første APi-kallet.
  ...
  /*I og med at vi henter ekstra-data til flere elementer, kan
  ...
  Inspirasjon: https://stackoverflow.com/questions/31710768/how-can-i-fetch-an-array-of-urls-with-promise-all*/
  ...
  detaljer om filmen. Hvis det motsatte skjer derimot så vil setMovies bli oppdatert med en tom array (ingenting).*/
